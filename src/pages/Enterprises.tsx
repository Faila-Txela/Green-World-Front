...
export default function Enterprises() {
  ...
  return(
    <div>
      ...
      {/* Hero Section */}
      <motion.div className="min-h-screen flex flex-col-reverse md:flex-row items-center justify-center py-20 px-8 md:px-16 space-y-12 md:space-y-20 md:space-x-16"
      ...
      >
        ...
        <div className="max-w-xl text-center md:text-left mt-20">
          ...
          <h1 className="font-semibold text-3xl md:text-5xl text-gary-800 mb-6">
            Transforme o Futuro com a <span className='text-4xl md:text-6xl text-primary'>Green World!</span>
          </h1>
          <p className="text-lg text-gray-600 mb-6">
            ...
            <PrimaryButton 
            name='Registre sua empresa' 
            addClassName='bg-primary rounded-full font-semibold text-white hover:scale-105' 
            onClick={() => navigate("/register-enterprise")} />

        </div>
        
        <div className="flex justify-center w-full max-w-md">
          <img className="w-full h-auto object-contain" src={image} alt="pessoas juntas" />
        </div>
        
      </motion.div>

      {/* Seção: Impacto */}
      <div className="py-16 px-8 md:px-16 bg-green-100">
      ...
      <div className="py-16 px-8 md:px-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm text-gray-600 mb-8">
            Ao registrar sua empresa na Green World, você se junta a um movimento global de transformação sustentável:
          </p>
      ...
      <div className="bg-gray-50 py-16 px-8 md:px-16">
        ...
        <div className="max-w-6xl md:max-w-4xl mx-auto text-center">
          <h2 className="font-semibold text-3xl text-primary mb-6">
          ...
          <div className="flex justify-center flex-col md:flex-row gap-8">
            <div className="bg-gray-100 p-6 rounded-lg shadow-xl w-full md:w-1/3">
              <p className="text-lg text-gray-600 mb-4">
                "A Green World tem sido fundamental para a implementação de nossas estratégias ambientais."
              </p>
            ...
            <div className="bg-gray-100 p-6 rounded-lg shadow-xl w-full md:w-1/3">
              <p className="text-lg text-gray-600 mb-4">
                "Com a Green World, conseguimos mapear áreas de lixo em nossa cidade e colaborar com outras empresas para promover um ambiente mais saudável para todos."
              </p>
